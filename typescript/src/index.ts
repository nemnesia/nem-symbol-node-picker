...
// NodeWatchのURLリスト
const nodewatchMainnetUrls = ['https://sse.nemnesia.com', 'https://nodewatch.symbol.tools'];
const nodewatchTestnetUrls = ['https://testnet.sse.nemnesia.com', 'https://nodewatch.symbol.tools/testnet'];
...
const symbolCache = new Map<string, CacheEntry>(); // Symbolノード用キャッシュ
const nemCache = new Map<string, CacheEntry>(); // NEMノード用キャッシュ
